...
const Hero = () => {
    return (
        <div className="flex flex-col items-start overflow-wrap-break-word text-left mt-[50px] md:w-1/2 w-[60%]  mx-auto ">
            ...
            <button class=" mt-[30px] flex items-center gap-2 px-4 py-2 font-bold text-white rounded-full bg-[#222222] transition-transform hover:scale-105 hover:bg-[#333333]">
                <span >Resume</span>
